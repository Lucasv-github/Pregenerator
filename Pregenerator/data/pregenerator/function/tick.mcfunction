execute if score Temp pregen_stage matches 5 unless entity @e[type=armor_stand,tag=pregen_marker_wait_ground,nbt={OnGround:1b}] run function pregenerator:done
